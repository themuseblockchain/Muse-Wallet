...
export default class Step1 extends Component {
  ...
  render() {
    ...
    if (typeof this.state.emailVal == 'undefined' || this.state.emailVal) {
        notValidClasses.emailCls = 'no-error col-md-12';
    }
    else {
       notValidClasses.emailCls = 'has-error col-md-12';
        ...
        <div className="margin-top-50">
          <form id="Form" className="form-horizontal">
            <div className="col-md-12">
                <h3>Please Provide your email address to continue the registration process</h3>
            </div>
            <div className="content">
              <div className="col-md-12 text-muted">
                Email verification helps with preventing spam
              </div>
            </div>
